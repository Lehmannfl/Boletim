...
<form action="index.jsp" method="post">
    ...
    <h6>Digite abaixo o número de sua Matrícula. Peça ao seu professor este número ou a Secretaria de sua Escola</h6>
...
<%DataProcessor dataProcessor = new DataProcessor();
    dataProcessor.processFile("C:/Users/Administrador/IdeaProjects/Boletim/src/main/java/Boletins/Dados.txt");%>
...
<% } else { %>
<% dados.add(new String[]{"Código da Escola não encontrado", idToQuery1}); %>
<% } %>
...
<% } else { %>
<% dados.add(new String[]{"Colunas de NOTAS & FALTAS não encontrada", idToQuery2}); %>
<% } %>
...
<% } else { %>
<% dados.add(new String[]{"Nome do ALUNO não encontrado", idToQuery3}); %>
<% } %>
